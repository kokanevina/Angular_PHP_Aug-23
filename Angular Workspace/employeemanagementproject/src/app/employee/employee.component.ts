...
export class EmployeeComponent {
  ...
  constructor(){
    ...
    this.employees.push(new Employee(321,"sudhakar puri",67000,"python Developer",new Date('12 Jun 2010'), "assets/Images/e321.jpg"));
    ...
    this.employees.push(new Employee(434,"AmOl Puranik",56000.33,"Java Developer",new Date('12 May 2015'),"assets/Images/e434.jpg"));
